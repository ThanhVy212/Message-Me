      ...
      <DialogContent className="overflow-y-auto p-0 bg-transparent border-0 shadow-2xl sm:max-w-2xl">
        <div className="bg-gradient-glass rounded-2xl border border-border/30 overflow-hidden">
          <div className="max-w-4xl mx-auto p-4">
            ...
            <div className="px-4 pb-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <p className="text-xs text-muted-foreground mt-1">Tiểu sử</p>
                ...
                <p className="text-xs text-muted-foreground">
                  Có thể ẩn xem email hoặc số điện thoại đối với người lạ trong
                  cài đặt
                </p>
              </div>
            </div>
            ...
            {/* Edit button */}
            <Button className="w-full text-white hover:opacity-90 transition-smooth">
